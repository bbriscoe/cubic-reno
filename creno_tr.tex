...
\newcommand*{\metaversion}{00C}
\newcommand*{\metadate}{03 Aug 2022}
...
\metaversion &\metadate  &Bob Briscoe &Added shallow buffer case, empirical results over PIE and discussion of the applicability of the synchronized loss model. Added Acks section. Altered analysis to use max window not min.\\\hline%
\hline%
\end{tabular}
