...
\newcommand*{\metadate}{02 Aug 2022}
...
\metaversion &\metadate  &Bob Briscoe &Added shallow buffer case, empirical results over PIE and discussion of the applicability of the synchronized loss model. Altered analysis to use max window not min.\\\hline%
\hline%
\end{tabular}
